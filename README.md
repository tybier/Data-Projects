# Data-Projects
My portfolio of various data projects using various machine learning models and analytical processes, mainly using R. Each project has an associated .docx file attached for viewing. Contents include:
